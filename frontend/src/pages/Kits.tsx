    ...
    <div className="max-w-6xl mx-auto">
      ...
      {!loading && !error && kits.length === 0 && (
        <div className="bg-white rounded-lg shadow-md p-12 text-center">
          <svg className="w-12 h-12 mx-auto text-gray-400 mb-4" width="48" height="48" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div key={kit.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
              ...
              <div className="pt-4 border-t border-gray-200 space-y-2">
                ...
                <button
                  ...
                  className="w-full bg-gray-100 text-gray-700 px-4 py-2 rounded hover:bg-gray-200 transition-colors flex items-center justify-center gap-2"
                >
